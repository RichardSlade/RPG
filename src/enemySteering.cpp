...
SteeringBehaviour<Enemy>::SteeringBehaviour(Enemy* host
                                     , const Params& params)
...
bool SteeringBehaviour<Enemy>::accumulateForce(sf::Vector2f& runningTotal, sf::Vector2f forceToAdd)
{
...
void SteeringBehaviour<Enemy>::createFeelers()
{
    mFeelers.clear();
...
sf::Vector2f SteeringBehaviour<Enemy>::rest()
{
...
sf::Vector2f SteeringBehaviour<Enemy>::arrive(sf::Vector2f targ, Deceleration deceleration)
{
...
sf::Vector2f SteeringBehaviour<Enemy>::seek(sf::Vector2f target)
{
...
sf::Vector2f SteeringBehaviour<Enemy>::evade()
{
...
sf::Vector2f SteeringBehaviour<Enemy>::flee(sf::Vector2f target)
{
...
sf::Vector2f SteeringBehaviour<Enemy>::wander(sf::Time dt)
{
...
sf::Vector2f SteeringBehaviour<Enemy>::followPath()
{
    if(mPath.isActive())
    {
...
sf::Vector2f SteeringBehaviour<Enemy>::obstacleAvoidance()
{
...
sf::Vector2f SteeringBehaviour<Enemy>::wallAvoidance()
{
    createFeelers();
...
sf::Vector2f SteeringBehaviour<Enemy>::seperation()
{
    sf::Vector2f steeringForce;
...
sf::Vector2f SteeringBehaviour<Enemy>::alignment()
{
...
sf::Vector2f SteeringBehaviour<Enemy>::cohesion()
{
...
sf::Vector2f SteeringBehaviour<Enemy>::flocking()
{
    sf::Vector2f steeringForce;
...
void SteeringBehaviour<Enemy>::setNewBehaviours(std::vector<SteeringBehaviour::Behaviour> newTypes)
{
    for(bool& b : mBehaviourFlags)
        b = false;
...
void SteeringBehaviour<Enemy>::setNewBehaviours(SteeringBehaviour::Behaviour newType)
{
    for(bool& b : mBehaviourFlags)
        b = false;
